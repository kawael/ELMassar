...
return Math.round((totalDistance / 1000) * 100) / 100; // Convert to kilometers and round to two decimals
}
export default function Sidebar({ targets, setTarget, tooltipDetails, polylines }) {
  return (
      ...
      <div className="tooltip-details">
        ...
        {tooltipDetails.length > 0 && (
          <div className="mb-4 p-2 border border-desert-sand rounded">
            ...
            <p>
              <b>Total Distance:</b> {calculateDistance(polylines[Object.keys(targets).find((key) => targets[key])])} km
            </p>
          </div>
        )}
      </div>
